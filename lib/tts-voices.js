...
(function exposeTtsVoices(root, factory) {
  ...
  const VOICE_OPTIONS = Object.freeze([
    ...
    { id: 'en-US-AriaNeural', label: 'Aria · 美式英语女声' },
    { id: 'en-US-JennyNeural', label: 'Jenny · 美式英语女声亲切' },
    { id: 'en-US-GuyNeural', label: 'Guy · 美式英语男声' },
    { id: 'en-US-AndrewNeural', label: 'Andrew · 美式英语男声温暖' },
    { id: 'en-GB-SoniaNeural', label: 'Sonia · 英式英语女声' },
    { id: 'en-GB-RyanNeural', label: 'Ryan · 英式英语男声' },
    { id: AUTO_VOICE, label: '自动 · 中文晓晓，英文 Aria' }
