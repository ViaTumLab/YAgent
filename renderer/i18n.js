...
(function installYanI18n(global) {
  const ZH_EN = Object.freeze({
    ...
    'Aria · 美式女声': 'Aria · US female', 'Jenny · 美式女声亲切': 'Jenny · friendly US female',
    'Guy · 美式男声': 'Guy · US male', 'Andrew · 美式男声温暖': 'Andrew · warm US male',
    'Sonia · 英式女声': 'Sonia · UK female', 'Ryan · 英式男声': 'Ryan · UK male',
    '自动 · 按中英文切换': 'Auto · Chinese/English',
